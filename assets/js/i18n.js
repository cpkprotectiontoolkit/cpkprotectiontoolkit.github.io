(function () {
  ...
  "en": {
    ...
    "pricing.note.paypalFeeText": "Prices include the PayPal 5.39% + $0.30 processing fee.",
  ...
  "es": {
    ...
    "pricing.note.paypalFeeText": "Los precios incluyen la comisión de procesamiento de PayPal del 5,39 % + $0.30.",
  ...
  "id": {
    ...
    "pricing.note.paypalFeeText": "Harga sudah termasuk biaya pemrosesan PayPal sebesar 5,39% + $0.30.",
  ...
  "zh-Hans": {
    ...
    "pricing.note.paypalFeeText": "价格已包含 PayPal 5.39% + $0.30 的交易处理费。",
